      ...
      <div>
        ...
        <div className="section-one">
          <div className="container">
            ...
            <div>
              ...
              <p>
                Have you been trying to lose weight, stay healthy and fit, but
                do not know how to go about it?   This is the perfect solution
        ...
        <div className="section-three">
          <div className="container">
            ...
            <p>
              Loosing weight is hard. There are lots of calculations involved.
            ...
            <div className="card-wrapper">
              <div className=" card-container">
                ...
                <p className="card-content">
                  Keep track of your weight and get a weekly report on how you
                  are doing and progress.  This keeps you focused on your goal
                  and spur you to do right thing and the right time
                </p>
              </div>
              <div className=" card-container">
                <img src={Icon2} alt="" />
